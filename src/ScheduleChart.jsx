...
const ASP_HOST = "http://bcdam-python-asp-service-extra.herokuapp.com/0.0.0.0:14512"; //localhost: no 0.0.0.0., then initial connect and discob\nnecy with emptying quueue s not there.
...
export default function ScheduleChart({ optimization_criterion }) {
    ...
    useEffect(() => {
        ...
        const socket = io(`${ASP_HOST}`, {
            ...
            cors: {
              origin: "wss://bcdam.herokuapp.com:35651/ws",
            },
